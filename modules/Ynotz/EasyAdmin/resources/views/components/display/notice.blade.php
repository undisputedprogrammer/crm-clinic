<div x-data="{
    ...
    >
    <div x-cloak class="mx-auto w-4/5 sm:w-2/3 md:w-2/5 p-4 rounded-md shadow-md bg-base-100 border-base-300 text-center flex flex-col items-center space-y-4">
